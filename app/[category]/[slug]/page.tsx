...
import PackageDetailPageClient from "@/components/package/PackageDetailPageClient";
...
export default async function Page({ params }: Props) {
    ...
    try {
        ...
        return <PackageDetailPageClient packageData={res.data} category={category} slug={slug} />;
    } catch (error) {
